...
this.getStyle(b).toInt()},this);Object.each(d.planes,function(a,d){var e;var j=d.capitalize(),i=this.getStyle(d);i=="auto"&&!h&&(h=this.getDimensions());e=c[d]=i=="auto"?h[d]:i.toInt(),i=e;g["total"+j]=i;a.each(function(a){var d=b(a,c);g["computed"+a.capitalize()]=d;g["total"+j]+=d})},this);return Object.append(g,c)}})})();
...
Fx.SmoothScroll=new Class({Extends:Fx.Scroll,options:{axes:["x","y"]},initialize:function(a,b){b=b||document;this.doc=b.getDocument();this.parent(this.doc,a);var d=b.getWindow(),c=d.location.href.match(/^[^#]*/)[0]+"#";$$(this.options.links||this.doc.links).each(function(a){if(a.href.indexOf(c)==0){var b=a.href.substr(c.length);b&&this.useLink(a,b)}},this);this.addEvent("complete",function(){d.location.hash=this.anchor;this.element.scrollTo(this.to[0],this.to[1])},true)},useLink:function(a,b){a.addEvent("click",
function(d){var c=document.id(b)||this.doc.getElement("a[name="+b+"]");if(c)d.preventDefault(),this.toElement(c,this.options.axes).chain(function(){this.fireEvent("scrolledTo",[a,c])}.bind(this)),this.anchor=b}.bind(this));return this}});