MooTools.More={version:"1.4.0.1",build:"a4244edf2aa97ac8a196fc96082dd35af1abab87"};Class.Mutators.Binds=function(a){this.prototype.initialize||this.implement("initialize",function(){});return Array.from(a).concat(this.prototype.Binds||[])};Class.Mutators.initialize=function(a){return function(){Array.from(this.Binds).each(function(a){var c=this[a];c&&(this[a]=c.bind(this))},this);return a.apply(this,arguments)}};
...
this.getStyle(c).toInt()},this);Object.each(c.planes,function(c,a){var f;var j=a.capitalize(),i=this.getStyle(a);i=="auto"&&!e&&(e=this.getDimensions());f=b[a]=i=="auto"?e[a]:i.toInt(),i=f;h["total"+j]=i;c.each(function(c){var a=d(c,b);h["computed"+c.capitalize()]=a;h["total"+j]+=a})},this);return Object.append(h,b)}})})();
...
b);a.left=Math.ceil(a.left);a.top=Math.ceil(a.top);delete a.x;delete a.y;return a},setPositionCoordinates:function(a,b,d){var e=a.offset.y,f=a.offset.x,g=d==document.body?window.getScroll():d.getPosition(),j=g.y,g=g.x,i=window.getSize();switch(a.position.x){case "left":b.x=g+f;break;case "right":b.x=g+f+d.offsetWidth;break;default:b.x=g+(d==document.body?i.x:d.offsetWidth)/2+f}switch(a.position.y){case "top":b.y=j+e;break;case "bottom":b.y=j+e+d.offsetHeight;break;default:b.y=j+(d==document.body?
i.y:d.offsetHeight)/2+e}},toMinMax:function(a,b){var d={left:"x",top:"y"},e;["minimum","maximum"].each(function(f){["left","top"].each(function(g){e=b[f]?b[f][d[g]]:null;if(e!=null&&(f=="minimum"?a[g]<e:a[g]>e))a[g]=e})})},toRelFixedPosition:function(a,b){var d=window.getScroll();b.top+=d.y;b.left+=d.x},toIgnoreScroll:function(a,b){var d=a.getScroll();b.top-=d.y;b.left-=d.x},toIgnoreMargins:function(a,b){a.left+=b.edge.x=="right"?b.dimensions["margin-right"]:b.edge.x!="center"?-b.dimensions["margin-left"]:
